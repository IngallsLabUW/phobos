...
phobos is an R package of custom functions for identifying and ranking unknown mass features (MFs) in metabolomics data, colloquially known as the MARS Project. The package annotates, ranks, and scores the unknown mass features, and performs common data transformations.
