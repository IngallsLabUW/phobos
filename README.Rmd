...
CL1 <- Confidence.Level.1 %>%
  select(compound_experimental:compound_theoretical, mz_similarity_score:confidence_source) %>%
  unique()
...
CL2 <- Confidence.Level.2 %>%
  ...
  select(compound_experimental:massbank_match, massbank_ppm, massbank_cosine_similarity, confidence_rank, confidence_source) %>%
  unique()
