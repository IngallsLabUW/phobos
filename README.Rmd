...
CL3 <- Confidence.Level.3 %>%
  arrange(compound_experimental) %>%
  select(MassFeature, compound_experimental:MoNA_Names, MH_mass_experimental, MH_mass_MoNA, mz_similarity_score_MoNa:confidence_source) %>%
  unique()
...
CL4 <- Confidence.Level.4 %>%
  ...
  select(MassFeature, compound_experimental:MoNA_Names, MH_mass_experimental, MH_mass_MoNA, mz_similarity_score_MoNa:confidence_source) %>%
  unique()
knitr::kable(CL4, caption = "Confidence Level 4")
```
