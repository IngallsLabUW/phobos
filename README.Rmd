...
For a complete description of the MARS annotation process, as well as all references for the equations used in the phobos package, please refer to the **TODO link website or github page here. This will also include the visual guide.**.
...
CL3_MoNA <- Confidence.Level.3_MoNA %>%
  ...
  unique()
knitr::kable(CL3[c(1, 2, 5, 6), ], caption = "Confidence Level 3: MoNA")
```
...
CL3_KEGG <- Confidence.Level.3_KEGG %>%
  ...
  unique()
knitr::kable(CL3[c(1, 66, 314, 355), ], caption = "Confidence Level 3: KEGG")
```
