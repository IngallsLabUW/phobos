...
- A central "homebase" database containing compiled mass features detected by the Ingalls lab with mz (mass/charge), rt (retention time, seconds), column, charge and ms2 data, as well as all previous MARS missions and metadata.
